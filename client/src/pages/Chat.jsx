...
//       <div className="border h-80 overflow-y-auto mb-3 p-2">
//         {messages.map((m, i) => (
//           <div key={i}>
...
//       />
//       <button onClick={sendMessage} className="mt-2 bg-blue-600 text-white px-4 py-2">
//         Send
//       </button>
//     </div>
//   );
...
//       `ws://localhost:3000?requestId=${requestId}`
//     );
//     socketRef.current = ws;
